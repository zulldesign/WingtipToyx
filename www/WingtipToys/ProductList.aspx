<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductList.aspx.cs" Inherits="WingtipToyx.ProductList" Title="Products" MasterPageFile="~/Site.Master" %>
				 ...
				 <section class="featured">
					<ul> 
						<asp:ListView ID="productList" runat="server"
							...
							GroupItemCount="3" ItemType="WingtipToyx.Models.Product" SelectMethod="GetProducts">
							<EmptyDataTemplate>      
